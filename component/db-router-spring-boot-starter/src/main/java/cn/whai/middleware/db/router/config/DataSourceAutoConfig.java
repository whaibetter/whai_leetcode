package cn.whai.middleware.db.router.config;

import cn.whai.middleware.db.router.DBRouterConfig;
import cn.whai.middleware.db.router.DBRouterJoinPoint;
import cn.whai.middleware.db.router.dynamic.DynamicDataSource;
import cn.whai.middleware.db.router.dynamic.DynamicMybatisPlugin;
import cn.whai.middleware.db.router.strategy.IDBRouterStrategy;
import cn.whai.middleware.db.router.strategy.impl.DBRouterStrategyHashCode;
import cn.whai.middleware.db.router.util.PropertyUtil;
...
public class DataSourceAutoConfig implements EnvironmentAware {
    ...
    @ConditionalOnMissingBean // 当容器没有这个Bean的时候，才会实例化一个切面
    ...
    public void setEnvironment(Environment environment) {
        ...
        // 分库分表数据源 mini-db-router.jdbc.datasource.list
